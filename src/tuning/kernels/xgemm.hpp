...
#include "../src/kernels/level3/xgemm_part4.opencl"
  ...
  if (V == 1) {  // Kernel 0: limited subset of tuning parameters - but explorable exhaustively
    settings.parameters = {
        {"GEMMK", {0}},         {"MWG", {16, 32, 64}},  {"NWG", {16, 32, 64}},  {"KWG", {32}},
        {"MDIMC", {8, 16, 32}}, {"NDIMC", {8, 16, 32}}, {"MDIMA", {8, 16, 32}}, {"NDIMB", {8, 16, 32}},
        {"KWI", {2}},           {"VWM", {1, 2, 4}},     {"VWN", {1, 2, 4}},     {"STRM", {0}},
        {"STRN", {0}},          {"SA", {0, 1}},         {"SB", {0, 1}},         {"KREG", {1}}};
  } else if (V == 2) {  // Kernel 0: a lot more tuning parameters - has to be sampled randomly, too much to test all
    settings.parameters = {{"GEMMK", {0}},
                           {"MWG", {16, 32, 64, 128}},
                           {"NWG", {16, 32, 64, 128}},
                           {"KWG", {16, 32}},
                           {"MDIMC", {8, 16, 32}},
    ...
    settings.parameters = {{"GEMMK", {1}},        {"MWG", {16, 32, 64}}, {"NWG", {16, 32, 64}}, {"KWG", {1}},
                           {"MDIMC", {4, 8, 16}}, {"NDIMC", {4, 8, 16}}, {"MDIMA", {4, 8, 16}}, {"NDIMB", {4, 8, 16}},
                           {"KWI", {1}},          {"VWM", {1, 2, 4}},    {"VWN", {1, 2, 4}},    {"STRM", {0}},
                           {"STRN", {0}},         {"SA", {0}},           {"SB", {0}},           {"KREG", {1, 2, 4}}};
  } else if (V == 12) {  // Kernel 1: a lot more tuning parameters - has to be sampled randomly, too much to test all
    settings.parameters = {{"GEMMK", {1}},
                           {"MWG", {8, 16, 32, 64, 128}},
                           {"NWG", {8, 16, 32, 64, 128}},
                           {"KWG", {1}},
                           {"MDIMC", {2, 4, 8, 16, 32}},
