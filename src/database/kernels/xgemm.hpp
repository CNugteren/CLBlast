  ...
  "Xgemm", Precision::kSingle, {
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        ...
        { "Intel(R) Core(TM) i7 CPU         920  @ 2.67GHz", { {"KWG",32}, {"KWI",2}, {"MDIMA",16}, {"MDIMC",8}, {"MWG",128}, {"NDIMB",16}, {"NDIMC",8}, {"NWG",64}, {"SA",0}, {"SB",0}, {"STRM",1}, {"STRN",0}, {"VWM",1}, {"VWN",2} } },
  ...
  "Xgemm", Precision::kComplexSingle, {
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        ...
        { "Intel(R) Core(TM) i7 CPU         920  @ 2.67GHz", { {"KWG",32}, {"KWI",2}, {"MDIMA",16}, {"MDIMC",16}, {"MWG",64}, {"NDIMB",8}, {"NDIMC",16}, {"NWG",64}, {"SA",0}, {"SB",1}, {"STRM",0}, {"STRN",0}, {"VWM",4}, {"VWN",4} } },
        ...
        { "default",                                         { {"KWG",32}, {"KWI",2}, {"MDIMA",16}, {"MDIMC",16}, {"MWG",64}, {"NDIMB",8}, {"NDIMC",8}, {"NWG",32}, {"SA",0}, {"SB",0}, {"STRM",0}, {"STRN",0}, {"VWM",4}, {"VWN",2} } },
      }
    },
    { // Intel GPUs
      kDeviceTypeGPU, "Intel", {
  ...
  "Xgemm", Precision::kDouble, {
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        ...
        { "Intel(R) Core(TM) i7 CPU         920  @ 2.67GHz", { {"KWG",32}, {"KWI",2}, {"MDIMA",32}, {"MDIMC",16}, {"MWG",128}, {"NDIMB",16}, {"NDIMC",16}, {"NWG",128}, {"SA",0}, {"SB",0}, {"STRM",1}, {"STRN",0}, {"VWM",1}, {"VWN",2} } },
        ...
        { "default",                                         { {"KWG",32}, {"KWI",2}, {"MDIMA",16}, {"MDIMC",16}, {"MWG",64}, {"NDIMB",8}, {"NDIMC",8}, {"NWG",64}, {"SA",1}, {"SB",1}, {"STRM",0}, {"STRN",0}, {"VWM",1}, {"VWN",4} } },
      }
    },
    { // Intel accelerators
      kDeviceTypeAccelerator, "Intel", {
  ...
  "Xgemm", Precision::kComplexDouble, {
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        ...
        { "Intel(R) Core(TM) i7 CPU         920  @ 2.67GHz", { {"KWG",32}, {"KWI",2}, {"MDIMA",16}, {"MDIMC",32}, {"MWG",128}, {"NDIMB",16}, {"NDIMC",8}, {"NWG",32}, {"SA",0}, {"SB",1}, {"STRM",0}, {"STRN",0}, {"VWM",4}, {"VWN",1} } },
