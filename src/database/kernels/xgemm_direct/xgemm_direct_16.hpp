             ...
             {"Ellesmere",
              {
                  {Name{"AMD Radeon RX 480                                 "},
                   Params{8, 32, 8, 8, 32, 1, 1, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"gfx1030",
              {
                  ...
                  {Name{"AMD Radeon RX 6900 XT                             "},
                   Params{16, 8, 8, 16, 8, 1, 0, 2, 1, 16, 0, 0, 0, 0, 0, 0}},
                  {kDeviceNameDefault, Params{2, 8, 8, 8, 8, 1, 1, 1, 2, 16, 0, 0, 0, 0, 0, 0}},
              }},
             {"gfx1031",
              {
                  {Name{"AMD Radeon RX 6700 XT                             "},
                   Params{16, 8, 8, 16, 8, 0, 0, 1, 1, 16, 0, 0, 0, 0, 0, 0}},
             ...
             {"gfx1035",
              {
                  {Name{"AMD Radeon Graphics                               "},
                   Params{16, 16, 32, 16, 8, 1, 1, 2, 1, 64, 0, 0, 0, 0, 0, 0}},
                  {kDeviceNameDefault, Params{16, 16, 32, 16, 8, 1, 1, 2, 1, 64, 0, 0, 0, 0, 0, 0}},
              }},
             {"gfx1036",
              {
                  {Name{"AMD Radeon Graphics                               "},
                   Params{8, 8, 8, 8, 8, 0, 0, 8, 2, 64, 0, 0, 0, 0, 0, 0}},
             ...
             {"gfx1201",
              {
                  {Name{"AMD Radeon RX 9070 XT                             "},
                   Params{2, 8, 8, 8, 8, 0, 0, 1, 1, 8, 0, 0, 0, 0, 0, 0}},
             ...
             {"default",
              {
                  {Name{"Mali-G57 MC2 r0p1                                 "},
                   Params{16, 16, 32, 8, 8, 0, 1, 1, 2, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Mali-T628                                         "},
        ...
        {// QUALCOMM GPUs
         ...
         "QUALCOMM",
         {
             {"default",
              {
                  {Name{"QUALCOMM Adreno(TM)                               "},
                   Params{16, 16, 16, 8, 8, 1, 1, 2, 4, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"OpenCL C 3.0 Adreno(TM) 740",
              {
                  {Name{"QUALCOMM Adreno(TM)                               "},
                   Params{2, 8, 16, 8, 8, 0, 1, 1, 2, 32, 0, 0, 0, 0, 0, 0}},
