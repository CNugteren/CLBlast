             ...
             {"Turks",
              {
                  {Name{"AMD Radeon HD 6770M                               "},
                   Params{2, 8, 8, 8, 8, 1, 1, 2, 2, 16, 0, 0, 0, 0, 0, 0}},
             ...
             {"gfx1010:xnack-",
              {
                  {Name{"AMD Radeon RX 5700                                "},
                   Params{8, 8, 16, 8, 16, 1, 1, 1, 2, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"gfx1030",
              {
                  ...
                  {Name{"AMD Radeon RX 6900 XT                             "},
                   Params{2, 8, 8, 8, 8, 1, 1, 1, 2, 16, 0, 0, 0, 0, 0, 0}},
                  {kDeviceNameDefault, Params{2, 8, 8, 8, 8, 1, 1, 2, 2, 16, 0, 0, 0, 0, 0, 0}},
              }},
             {"gfx1031",
              {
                  {Name{"AMD Radeon RX 6700 XT                             "},
                   Params{8, 8, 8, 8, 16, 1, 1, 4, 1, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"gfx1034",
              {
                  {Name{"AMD Radeon RX 6500 XT                             "},
                   Params{2, 16, 16, 16, 16, 1, 1, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
                  {kDeviceNameDefault, Params{2, 16, 16, 16, 16, 1, 1, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
              }},
             {"gfx1035",
              {
                  {Name{"AMD Radeon Graphics                               "},
                   Params{2, 16, 16, 16, 16, 1, 1, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"gfx1100",
              {
                  {Name{"Radeon RX 7900 XTX                                "},
                   Params{2, 16, 16, 8, 8, 1, 1, 1, 2, 16, 0, 0, 0, 0, 0, 0}},
                  {kDeviceNameDefault, Params{2, 16, 16, 8, 8, 1, 1, 1, 2, 16, 0, 0, 0, 0, 0, 0}},
              }},
             {"gfx1101",
              {
                  {Name{"AMD Radeon RX 7800 XT                             "},
                   Params{2, 8, 16, 8, 16, 1, 0, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
        ...
        {// ARM GPUs
         ...
         "ARM",
         {
             {"default",
              {
                  {Name{"Mali-T760                                         "},
                   Params{8, 8, 8, 8, 16, 1, 0, 2, 1, 16, 0, 0, 0, 0, 0, 0}},
        ...
        {// Apple GPUs
         ...
         "Apple",
         {
             {"default",
              {
                  {Name{"Apple M1                                          "},
                   Params{2, 8, 16, 16, 8, 0, 1, 1, 1, 16, 0, 0, 0, 0, 0, 0}},
                  {Name{"Apple M2 Max                                      "},
             ...
             {"default",
              {
                  {Name{"Intel(R) Core(TM) i7-2670QM CPU @ 2.20GHz         "},
                   Params{2, 8, 8, 8, 8, 0, 0, 4, 4, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) Core(TM) i5-4570 CPU @ 3.20GHz           "},
                   Params{2, 16, 8, 16, 8, 0, 0, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) Core(TM) i5-4590S CPU @ 3.00GHz          "},
                   Params{16, 32, 32, 8, 8, 1, 0, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) Core(TM) i5-6200U CPU @ 2.30GHz          "},
                   Params{8, 8, 8, 8, 8, 0, 0, 1, 1, 8, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) Core(TM) i7 CPU         920  @ 2.67GHz   "},
                   Params{2, 16, 16, 8, 8, 1, 1, 1, 4, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) Core(TM) i7-4790K CPU @ 4.00GHz          "},
                   Params{2, 8, 8, 16, 8, 1, 1, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"default",
              {
                  ...
                  {Name{"Intel(R) Iris(R) Xe Graphics                      "},
                   Params{2, 8, 8, 8, 16, 0, 0, 2, 2, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) RaptorLake-S Mobile Graphics Controller  "},
                   Params{2, 16, 16, 16, 8, 0, 0, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"default",
              {
                  {Name{"Intel(R) FPGA Emulation Device                    "},
                   Params{2, 32, 32, 8, 8, 1, 1, 1, 2, 32, 0, 0, 0, 0, 0, 0}},
                  {kDeviceNameDefault, Params{2, 32, 32, 8, 8, 1, 1, 1, 2, 32, 0, 0, 0, 0, 0, 0}},
              }},
         }},
        {// NVIDIA GPUs
         ...
         "NVIDIA",
         {
             ...
             {"SM5.0",
              {
                  {Name{"GeForce 920MX                                     "},
                   Params{8, 16, 16, 16, 8, 1, 1, 1, 2, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"GeForce GTX 750 Ti                                "},
                   Params{16, 8, 8, 16, 8, 1, 1, 2, 1, 16, 0, 0, 0, 0, 0, 0}},
                  {Name{"Quadro M2000M                                     "},
                   Params{8, 8, 16, 8, 8, 1, 0, 1, 4, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"SM6.0",
              {
                  {Name{"Tesla P100-PCIE-16GB                              "},
                   Params{16, 16, 8, 8, 16, 1, 0, 1, 1, 16, 0, 0, 0, 0, 0, 0}},
             ...
             {"SM6.1",
              {
                  ...
                  {Name{"GeForce GTX 1070 Ti                               "},
                   Params{2, 8, 8, 16, 8, 1, 1, 1, 1, 16, 0, 0, 0, 0, 0, 0}},
                  {Name{"GeForce GTX 1080                                  "},
                   Params{8, 8, 16, 16, 8, 1, 1, 2, 2, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"GeForce GTX 1080 Ti                               "},
                   Params{2, 16, 8, 16, 8, 1, 1, 1, 1, 16, 0, 0, 0, 0, 0, 0}},
                  {Name{"NVIDIA GeForce GTX 1060 6GB                       "},
                   Params{2, 8, 8, 8, 8, 1, 1, 2, 1, 16, 0, 0, 0, 0, 0, 0}},
             ...
             {"SM7.5",
              {
                  {Name{"GeForce GTX 1650                                  "},
                   Params{2, 32, 32, 8, 8, 1, 1, 1, 4, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"SM8.0",
              {
                  {Name{"A100-PCIE-40GB                                    "},
                   Params{2, 8, 16, 16, 8, 1, 1, 1, 1, 16, 0, 0, 0, 0, 0, 0}},
                  {kDeviceNameDefault, Params{2, 8, 16, 16, 8, 1, 1, 1, 1, 16, 0, 0, 0, 0, 0, 0}},
              }},
             {"SM8.6",
              {
                  {Name{"NVIDIA GeForce RTX 2050                           "},
                   Params{2, 16, 16, 8, 8, 1, 0, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"NVIDIA GeForce RTX 3050 Laptop GPU                "},
                   Params{2, 8, 8, 8, 8, 1, 1, 1, 1, 16, 0, 0, 0, 0, 0, 0}},
                  {Name{"NVIDIA GeForce RTX 3050 Ti Laptop GPU             "},
                   Params{16, 16, 16, 16, 8, 1, 0, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
