        ...
        {// AMD GPUs
         ...
         "AMD",
         {
             {"Ellesmere",
              {
                  {Name{"AMD Radeon RX 480                                 "},
                   Params{16, 32, 32, 16, 8, 0, 0, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"gfx1030",
              {
                  {Name{"AMD Radeon RX 6800 XT                             "},
                   Params{16, 8, 16, 8, 8, 0, 0, 1, 2, 16, 0, 0, 0, 0, 0, 0}},
             ...
             {"gfx1103",
              {
                  {Name{"AMD Radeon 780M Graphics                          "},
                   Params{16, 32, 32, 8, 8, 1, 0, 1, 4, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"gfx90c",
              {
                  {Name{"AMD Radeon(TM) Graphics                           "},
                   Params{2, 16, 16, 16, 16, 0, 0, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"default",
              {
                  {Name{"Intel(R) Core(TM) i7-2670QM CPU @ 2.20GHz         "},
                   Params{2, 8, 8, 32, 8, 0, 0, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) Core(TM) i5-4570 CPU @ 3.20GHz           "},
                   Params{2, 16, 16, 8, 8, 0, 0, 1, 4, 32, 0, 0, 0, 0, 0, 0}},
                  ...
                  {Name{"Intel(R) Core(TM) i5-6200U CPU @ 2.30GHz          "},
                   Params{2, 8, 8, 8, 8, 0, 0, 2, 2, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) Core(TM) i7 CPU         920  @ 2.67GHz   "},
                   Params{8, 16, 16, 8, 8, 0, 0, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) Core(TM) i7-4790K CPU @ 4.00GHz          "},
                   Params{8, 16, 8, 8, 8, 0, 0, 2, 2, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) Core(TM) i7-6770HQ CPU @ 2.60GHz         "},
                   Params{2, 32, 8, 8, 8, 0, 0, 1, 4, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) Core(TM) i9-9980HK CPU @ 2.40GHz         "},
                   Params{2, 8, 32, 32, 8, 0, 0, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"default",
              {
                  ...
                  {Name{"Intel(R) Iris(R) Plus Graphics 640                "},
                   Params{2, 32, 16, 16, 8, 0, 0, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) UHD Graphics                             "},
                   Params{2, 16, 16, 16, 8, 0, 0, 1, 2, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Intel(R) UHD Graphics 620                         "},
                   Params{2, 16, 8, 16, 16, 0, 0, 2, 2, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"SM6.1",
              {
                  ...
                  {Name{"NVIDIA GeForce GTX 1060 6GB                       "},
                   Params{8, 16, 32, 16, 16, 1, 1, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"NVIDIA GeForce MX150                              "},
                   Params{16, 16, 32, 8, 8, 1, 0, 1, 4, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"TITAN X (Pascal)                                  "},
                   Params{2, 16, 16, 8, 8, 1, 1, 1, 2, 16, 0, 0, 0, 0, 0, 0}},
                  {Name{"Tesla P4                                          "},
                   Params{2, 16, 16, 8, 8, 1, 1, 1, 2, 16, 0, 0, 0, 0, 0, 0}},
             ...
             {"SM7.5",
              {
                  ...
                  {Name{"NVIDIA GeForce RTX 2080 Ti                        "},
                   Params{2, 32, 32, 16, 16, 1, 1, 1, 2, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"SM8.6",
              {
                  {Name{"NVIDIA GeForce RTX 2050                           "},
                   Params{16, 8, 8, 16, 16, 0, 1, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
