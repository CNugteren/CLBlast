        ...
        {// AMD GPUs
         ...
         "AMD",
         {
             ...
             {"gfx1030",
              {
                  {Name{"AMD Radeon RX 6800 XT                             "},
                   Params{1, 16, 8, 8, 16, 0, 0, 1, 1, 16, 0, 0, 0, 0, 0, 0}},
                  {kDeviceNameDefault, Params{1, 16, 8, 8, 16, 0, 0, 1, 1, 16, 0, 0, 0, 0, 0, 0}},
              }},
             {"gfx1031",
              {
                  {Name{"AMD Radeon RX 6700 XT                             "},
                   Params{1, 8, 8, 16, 16, 0, 0, 2, 2, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"gfx1036",
              {
                  {Name{"AMD Radeon Graphics                               "},
                   Params{1, 8, 8, 8, 16, 0, 0, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
                  {kDeviceNameDefault, Params{1, 8, 8, 8, 16, 0, 0, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
              }},
             {"gfx1100",
              {
                  {Name{"Radeon RX 7900 XTX                                "},
                   Params{1, 8, 16, 8, 16, 0, 0, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
                  {kDeviceNameDefault, Params{1, 8, 16, 8, 16, 0, 0, 2, 1, 32, 0, 0, 0, 0, 0, 0}},
              }},
             {"gfx906:sramecc+:xnack-",
              {
                  {Name{"AMD Radeon VII                                    "},
                   Params{1, 16, 32, 8, 8, 0, 0, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"default",
              {
                  ...
                  {Name{"Intel(R) UHD Graphics 620                         "},
                   Params{1, 8, 8, 32, 8, 0, 0, 4, 1, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"SM12.0",
              {
                  {Name{"NVIDIA GeForce RTX 5070 Ti                        "},
                   Params{1, 8, 16, 8, 8, 0, 0, 1, 1, 16, 0, 0, 0, 0, 0, 0}},
             ...
             {"SM7.5",
              {
                  {Name{"NVIDIA GeForce RTX 2080 Ti                        "},
                   Params{1, 16, 8, 16, 8, 0, 0, 1, 1, 16, 0, 0, 0, 0, 0, 0}},
                  {Name{"Quadro T2000                                      "},
                   Params{1, 8, 16, 32, 8, 0, 0, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"Tesla T4                                          "},
                   Params{1, 8, 16, 32, 8, 0, 0, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
             ...
             {"SM8.6",
              {
                  {Name{"NVIDIA GeForce RTX 3060                           "},
                   Params{1, 32, 8, 16, 16, 0, 0, 1, 2, 32, 0, 0, 0, 0, 0, 0}},
                  {Name{"NVIDIA GeForce RTX 3090                           "},
                   Params{1, 8, 16, 32, 8, 0, 0, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
                  {kDeviceNameDefault, Params{1, 32, 8, 16, 16, 0, 0, 1, 2, 32, 0, 0, 0, 0, 0, 0}},
              }},
             {"default",
              {
                  {kDeviceNameDefault, Params{1, 16, 32, 8, 8, 0, 0, 1, 1, 32, 0, 0, 0, 0, 0, 0}},
