  ...
  "Xconvgemm", Precision::kDouble, {"KWID", "MDIMAD", "MDIMCD", "NDIMBD", "NDIMCD", "PADA", "PADB", "VWMD", "VWND", "WGD"}, {
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        ...
        { "gfx1036", {
          { Name{"AMD Radeon Graphics                               "}, Params{ 1, 8, 8, 8, 16, 0, 0, 2, 1, 32, 0, 0, 0, 0, 0, 0 } },
    ...
    { // Intel CPUs
      kDeviceTypeCPU, "Intel", {
        { "default", {
          ...
          { Name{"cpu-penryn-Intel(R) Core(TM)2 Duo CPU     T6670  @"}, Params{ 1, 8, 16, 16, 8, 0, 0, 1, 2, 32, 0, 0, 0, 0, 0, 0 } },
    ...
    { // Intel GPUs
      kDeviceTypeGPU, "Intel", {
        { "default", {
          ...
          { Name{"Intel(R) UHD Graphics                             "}, Params{ 1, 16, 8, 16, 8, 0, 0, 2, 2, 32, 0, 0, 0, 0, 0, 0 } },
    ...
    { // NVIDIA GPUs
      kDeviceTypeGPU, "NVIDIA", {
        { "SM12.0", {
          { Name{"NVIDIA GeForce RTX 5070 Ti                        "}, Params{ 1, 8, 16, 8, 8, 0, 0, 1, 1, 16, 0, 0, 0, 0, 0, 0 } },
        ...
        { "SM8.6", {
          { Name{"NVIDIA GeForce RTX 3060                           "}, Params{ 1, 32, 8, 16, 16, 0, 0, 1, 2, 32, 0, 0, 0, 0, 0, 0 } },
