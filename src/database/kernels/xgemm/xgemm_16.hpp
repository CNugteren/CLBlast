             ...
             {"Ellesmere",
              {
                  ...
                  {Name{"AMD Radeon RX 580 2048SP                          "},
                   Params{0, 1, 16, 2, 16, 16, 128, 16, 16, 128, 1, 1, 1, 1, 8, 1}},
             ...
             {"gfx1010:xnack-",
              {
                  {Name{"AMD Radeon RX 5700                                "},
                   Params{0, 1, 16, 2, 16, 8, 128, 16, 32, 128, 1, 1, 1, 0, 8, 4}},
             ...
             {"gfx1031",
              {
                  {Name{"AMD Radeon RX 6700 XT                             "},
                   Params{0, 1, 32, 2, 8, 8, 64, 8, 8, 64, 1, 1, 0, 0, 4, 4}},
                  {kDeviceNameDefault, Params{0, 1, 32, 2, 8, 8, 64, 8, 8, 64, 1, 1, 0, 0, 4, 4}},
              }},
             {"gfx1032",
              {
             ...
             {"gfx1034",
              {
                  {Name{"AMD Radeon RX 6500 XT                             "},
                   Params{0, 1, 32, 2, 16, 16, 128, 32, 8, 128, 1, 1, 0, 0, 2, 4}},
                  {kDeviceNameDefault, Params{0, 1, 32, 2, 16, 16, 128, 32, 8, 128, 1, 1, 0, 0, 2, 4}},
              }},
             {"gfx1035",
              {
                  {Name{"AMD Radeon Graphics                               "},
                   Params{0, 1, 16, 2, 8, 8, 64, 8, 8, 128, 1, 1, 1, 0, 2, 1}},
             ...
             {"gfx1103",
              {
                  {Name{"AMD Radeon 780M Graphics                          "},
                   Params{0, 1, 32, 2, 8, 8, 128, 8, 16, 128, 1, 1, 1, 0, 8, 1}},
                  {kDeviceNameDefault, Params{0, 1, 32, 2, 8, 8, 128, 8, 16, 128, 1, 1, 1, 0, 8, 1}},
              }},
             {"gfx1201",
              {
                  {Name{"AMD Radeon RX 9070 XT                             "},
                   Params{0, 1, 32, 2, 8, 8, 64, 8, 8, 64, 1, 1, 0, 0, 2, 4}},
             ...
             {"gfx906:sramecc+:xnack-",
              {
                  {Name{"AMD Instinct MI50/MI60                            "},
                   Params{0, 1, 32, 2, 8, 8, 32, 16, 16, 64, 1, 1, 0, 0, 2, 4}},
                  {Name{"AMD Radeon VII                                    "},
                   Params{0, 1, 32, 2, 8, 8, 32, 16, 16, 64, 1, 1, 0, 0, 2, 4}},
             ...
             {"default",
              {
                  {Name{"PowerVR B-Series BXE-4-32                         "},
                   Params{0, 1, 32, 2, 16, 16, 64, 8, 8, 64, 0, 0, 0, 0, 1, 2}},
             ...
             {"default",
              {
                  ...
                  {Name{"Intel(R) HD Graphics 620                          "},
                   Params{0, 1, 32, 2, 8, 8, 64, 8, 8, 64, 0, 0, 0, 0, 1, 1}},
                  {Name{"Intel(R) HD Graphics Skylake ULT GT2              "},
                   Params{0, 1, 16, 2, 8, 8, 32, 16, 16, 128, 0, 1, 1, 0, 4, 8}},
