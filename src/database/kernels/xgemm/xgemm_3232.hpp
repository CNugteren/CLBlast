  ...
  "Xgemm", Precision::kComplexSingle, {"KWG", "KWI", "MDIMA", "MDIMC", "MWG", "NDIMB", "NDIMC", "NWG", "SA", "SB", "STRM", "STRN", "VWM", "VWN"}, {
    { // AMD GPUs
      kDeviceTypeGPU, "AMD", {
        ...
        { "default", {
          { Name{"AMD Radeon Pro 580 Compute Engine                 "}, Params{ 32, 2, 16, 16, 32, 8, 8, 32, 0, 0, 0, 0, 2, 1 } },
    ...
    { // Intel GPUs
      kDeviceTypeGPU, "Intel", {
        { "default", {
          ...
          { kDeviceNameDefault                                        , Params{ 32, 2, 16, 16, 64, 32, 32, 128, 1, 1, 1, 0, 2, 2 } },
        } },
      }
    },
    { // Intel accelerators
    ...
    { // NVIDIA GPUs
      kDeviceTypeGPU, "NVIDIA", {
        ...
        { "SM5.2", {
          { Name{"GeForce GTX 970                                   "}, Params{ 16, 2, 8, 16, 64, 8, 8, 64, 0, 0, 1, 0, 1, 4 } },
          ...
          { kDeviceNameDefault                                        , Params{ 16, 2, 8, 8, 64, 8, 8, 32, 0, 0, 1, 0, 1, 1 } },
        } },
        { "SM6.1", {
