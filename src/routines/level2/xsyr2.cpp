...
template <typename T>
Xsyr2<T>::Xsyr2(Queue& queue, EventPointer event, const std::string& name) : Xher2<T>(queue, event, name) {}

// =================================================================================================

// The main routine
template <typename T>
void Xsyr2<T>::DoSyr2(const Layout layout, const Triangle triangle, const size_t n, const T alpha,
  ...
  DoHer2(layout, triangle, n, alpha, x_buffer, x_offset, x_inc, y_buffer, y_offset, y_inc, a_buffer, a_offset, a_ld);
}
