...
Xhpr<T,U>::Xhpr(Queue &queue, EventPointer event, const std::vector<EventPointer>& event_wait_list, const std::string &name):
    Xher<T,U>(queue, event, event_wait_list, name) {
}
