...
template <typename T>
Xsyr<T>::Xsyr(Queue &queue, EventPointer event, const std::vector<EventPointer>& event_wait_list, const std::string &name):
    Xher<T,T>(queue, event, event_wait_list, name) {
}
