...
template <typename T>
Xgerc<T>::Xgerc(Queue &queue, EventPointer event, const std::vector<EventPointer>& event_wait_list, const std::string &name):
    Xger<T>(queue, event, event_wait_list, name) {
}
