...
Xher2k<T,U>::Xher2k(Queue &queue, EventPointer event, const std::vector<EventPointer>& event_wait_list, const std::string &name):
    Xherk<T,U>(queue, event, event_wait_list, name) {
}
