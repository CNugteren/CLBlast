...
template <typename T>
Xasum<T>::Xasum(Queue &queue, EventPointer event, const std::vector<EventPointer>& event_wait_list, const std::string &name):
    Routine(queue, event, event_wait_list, name, {"Xdot"}, PrecisionValue<T>(), {}, {
