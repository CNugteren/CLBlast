...
StatusCode Rotg(cl_mem, const size_t,
                ...
                cl_mem, const size_t,
                cl_mem, const size_t,
                cl_command_queue*, cl_event*, const std::vector<cl_event*>&) {
...
StatusCode Swap(const size_t n,
  ...
  try {
    ...
    auto routine = Xswap<T>(queue_cpp, event, event_wait_list);
    routine.DoSwap(n,
...
StatusCode Scal(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xscal<T>(queue_cpp, event, event_wait_list);
    routine.DoScal(n,
                   alpha,
                   Buffer<T>(x_buffer), x_offset, x_inc);
    return StatusCode::kSuccess;
...
StatusCode Copy(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xcopy<T>(queue_cpp, event, event_wait_list);
    routine.DoCopy(n,
                   Buffer<T>(x_buffer), x_offset, x_inc,
                   Buffer<T>(y_buffer), y_offset, y_inc);
    return StatusCode::kSuccess;
...
StatusCode Axpy(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xaxpy<T>(queue_cpp, event, event_wait_list);
    routine.DoAxpy(n,
                   alpha,
                   Buffer<T>(x_buffer), x_offset, x_inc,
                   Buffer<T>(y_buffer), y_offset, y_inc);
...
StatusCode Dot(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xdot<T>(queue_cpp, event, event_wait_list);
    routine.DoDot(n,
...
StatusCode Dotu(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xdotu<T>(queue_cpp, event, event_wait_list);
    routine.DoDotu(n,
                   Buffer<T>(dot_buffer), dot_offset,
                   Buffer<T>(x_buffer), x_offset, x_inc,
                   Buffer<T>(y_buffer), y_offset, y_inc);
...
StatusCode Dotc(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xdotc<T>(queue_cpp, event, event_wait_list);
    routine.DoDotc(n,
                   Buffer<T>(dot_buffer), dot_offset,
                   Buffer<T>(x_buffer), x_offset, x_inc,
                   Buffer<T>(y_buffer), y_offset, y_inc);
...
StatusCode Nrm2(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xnrm2<T>(queue_cpp, event, event_wait_list);
    routine.DoNrm2(n,
...
StatusCode Asum(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xasum<T>(queue_cpp, event, event_wait_list);
    routine.DoAsum(n,
...
StatusCode Sum(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xsum<T>(queue_cpp, event, event_wait_list);
    routine.DoSum(n,
...
StatusCode Amax(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xamax<T>(queue_cpp, event, event_wait_list);
    routine.DoAmax(n,
...
StatusCode Amin(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xamin<T>(queue_cpp, event, event_wait_list);
    routine.DoAmin(n,
...
StatusCode Max(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xmax<T>(queue_cpp, event, event_wait_list);
    routine.DoMax(n,
                  Buffer<unsigned int>(imax_buffer), imax_offset,
                  Buffer<T>(x_buffer), x_offset, x_inc);
    return StatusCode::kSuccess;
...
StatusCode Min(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xmin<T>(queue_cpp, event, event_wait_list);
    routine.DoMin(n,
                  Buffer<unsigned int>(imin_buffer), imin_offset,
                  Buffer<T>(x_buffer), x_offset, x_inc);
    return StatusCode::kSuccess;
...
StatusCode Gemv(const Layout layout, const Transpose a_transpose,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xgemv<T>(queue_cpp, event, event_wait_list);
...
StatusCode Gbmv(const Layout layout, const Transpose a_transpose,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xgbmv<T>(queue_cpp, event, event_wait_list);
...
StatusCode Hemv(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xhemv<T>(queue_cpp, event, event_wait_list);
...
StatusCode Hbmv(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xhbmv<T>(queue_cpp, event, event_wait_list);
...
StatusCode Hpmv(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xhpmv<T>(queue_cpp, event, event_wait_list);
...
StatusCode Symv(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xsymv<T>(queue_cpp, event, event_wait_list);
...
StatusCode Sbmv(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xsbmv<T>(queue_cpp, event, event_wait_list);
...
StatusCode Spmv(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xspmv<T>(queue_cpp, event, event_wait_list);
...
StatusCode Trmv(const Layout layout, const Triangle triangle, const Transpose a_transpose, const Diagonal diagonal,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xtrmv<T>(queue_cpp, event, event_wait_list);
...
StatusCode Tbmv(const Layout layout, const Triangle triangle, const Transpose a_transpose, const Diagonal diagonal,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xtbmv<T>(queue_cpp, event, event_wait_list);
...
StatusCode Tpmv(const Layout layout, const Triangle triangle, const Transpose a_transpose, const Diagonal diagonal,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xtpmv<T>(queue_cpp, event, event_wait_list);
...
StatusCode Trsv(const Layout layout, const Triangle triangle, const Transpose a_transpose, const Diagonal diagonal,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xtrsv<T>(queue_cpp, event, event_wait_list);
...
StatusCode Ger(const Layout layout,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xger<T>(queue_cpp, event, event_wait_list);
...
StatusCode Geru(const Layout layout,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xgeru<T>(queue_cpp, event, event_wait_list);
...
StatusCode Gerc(const Layout layout,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xgerc<T>(queue_cpp, event, event_wait_list);
...
StatusCode Her(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xher<std::complex<T>,T>(queue_cpp, event, event_wait_list);
...
StatusCode Hpr(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xhpr<std::complex<T>,T>(queue_cpp, event, event_wait_list);
...
StatusCode Her2(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xher2<T>(queue_cpp, event, event_wait_list);
...
StatusCode Hpr2(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xhpr2<T>(queue_cpp, event, event_wait_list);
...
StatusCode Syr(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xsyr<T>(queue_cpp, event, event_wait_list);
...
StatusCode Spr(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xspr<T>(queue_cpp, event, event_wait_list);
...
StatusCode Syr2(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xsyr2<T>(queue_cpp, event, event_wait_list);
...
StatusCode Spr2(const Layout layout, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xspr2<T>(queue_cpp, event, event_wait_list);
...
StatusCode Gemm(const Layout layout, const Transpose a_transpose, const Transpose b_transpose,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xgemm<T>(queue_cpp, event, event_wait_list);
...
template StatusCode PUBLIC_API Gemm<float>(const Layout, const Transpose, const Transpose,
                                           ...
                                           const float,
                                           cl_mem, const size_t, const size_t,
                                           cl_command_queue*, cl_event*, const std::vector<cl_event*>&, cl_mem);
...
StatusCode Symm(const Layout layout, const Side side, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xsymm<T>(queue_cpp, event, event_wait_list);
...
StatusCode Hemm(const Layout layout, const Side side, const Triangle triangle,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xhemm<T>(queue_cpp, event, event_wait_list);
...
StatusCode Syrk(const Layout layout, const Triangle triangle, const Transpose a_transpose,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xsyrk<T>(queue_cpp, event, event_wait_list);
...
StatusCode Herk(const Layout layout, const Triangle triangle, const Transpose a_transpose,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xherk<std::complex<T>,T>(queue_cpp, event, event_wait_list);
...
StatusCode Syr2k(const Layout layout, const Triangle triangle, const Transpose ab_transpose,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xsyr2k<T>(queue_cpp, event, event_wait_list);
...
StatusCode Her2k(const Layout layout, const Triangle triangle, const Transpose ab_transpose,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xher2k<T,U>(queue_cpp, event, event_wait_list);
...
StatusCode Trmm(const Layout layout, const Side side, const Triangle triangle, const Transpose a_transpose, const Diagonal diagonal,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xtrmm<T>(queue_cpp, event, event_wait_list);
...
StatusCode Trsm(const Layout layout, const Side side, const Triangle triangle, const Transpose a_transpose, const Diagonal diagonal,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xtrsm<T>(queue_cpp, event, event_wait_list);
...
StatusCode Had(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xhad<T>(queue_cpp, event, event_wait_list);
    routine.DoHad(n,
                  alpha,
                  Buffer<T>(x_buffer), x_offset, x_inc,
                  Buffer<T>(y_buffer), y_offset, y_inc,
...
StatusCode Omatcopy(const Layout layout, const Transpose a_transpose,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xomatcopy<T>(queue_cpp, event, event_wait_list);
...
StatusCode Im2col(const KernelMode kernel_mode,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xim2col<T>(queue_cpp, event, event_wait_list);
...
StatusCode Col2im(const KernelMode kernel_mode,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xcol2im<T>(queue_cpp, event, event_wait_list);
...
StatusCode Convgemm(const KernelMode kernel_mode,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = Xconvgemm<T>(queue_cpp, event, event_wait_list);
...
StatusCode AxpyBatched(const size_t n,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = XaxpyBatched<T>(queue_cpp, event, event_wait_list);
...
StatusCode GemmBatched(const Layout layout, const Transpose a_transpose, const Transpose b_transpose,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = XgemmBatched<T>(queue_cpp, event, event_wait_list);
    auto alphas_cpp = std::vector<T>();
...
StatusCode GemmStridedBatched(const Layout layout, const Transpose a_transpose, const Transpose b_transpose,
  ...
  try {
    auto queue_cpp = Queue(*queue);
    auto routine = XgemmStridedBatched<T>(queue_cpp, event, event_wait_list);
